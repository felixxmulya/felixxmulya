...
export default function About() {
   ...
   return (
      <section id="about" className="flex flex-col md:flex-row h-auto md:h-[70vh] md:justify-between mx-auto max-w-6xl py-16 px-6 space-y-8 md:space-y-0 md:space-x-8">
